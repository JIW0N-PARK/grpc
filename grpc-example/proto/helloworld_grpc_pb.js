...
function serialize_helloworld_HelloReq(arg) {
  if (!(arg instanceof helloworld_pb.HelloReq)) {
...
function deserialize_helloworld_HelloReq(buffer_arg) {
  return helloworld_pb.HelloReq.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_helloworld_HelloRes(arg) {
  if (!(arg instanceof helloworld_pb.HelloRes)) {
...
function deserialize_helloworld_HelloRes(buffer_arg) {
  return helloworld_pb.HelloRes.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var GreeterService = exports.GreeterService = {
  sayHello: {
    ...
    requestType: helloworld_pb.HelloReq,
    responseType: helloworld_pb.HelloRes,
